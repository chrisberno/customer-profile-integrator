...
export declare class AgentCopilotHelper {
    ...
    static hasRequiredFlexFeatureFlagsForCopilotConfiguration: (task?: ITask) => boolean;
    /**
    ...
    static readonly isAgentCopilotActiveForQueue: (queueSid: string, config?: AgentCopilotConfigState) => boolean;
