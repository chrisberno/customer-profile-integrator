import { BaseITask } from "./BaseITask";
/**
 * Worker skills
 ...
 * Worker
 * @interface IWorker
 * @property {object} source source object backing the worker
 ...
 * @property {IWorker.WorkerAttributes} attributes attributes of the worker
...
export declare function wait(interval?: number): Promise<unknown>;
export type TaskFilterCallback = (task: BaseITask) => boolean;
