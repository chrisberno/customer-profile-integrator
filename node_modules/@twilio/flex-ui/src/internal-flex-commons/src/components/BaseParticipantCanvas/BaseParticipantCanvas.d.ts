...
declare const BaseParticipantCanvasThemed: React.FC<Pick<BaseParticipantCanvasProps, "templates" | "cancelTransfer" | "task" | "hideActions" | "isCCAICall" | "participantWidth" | "participant" | "listMode" | "isTaskAssignedToCurrentWorker" | "kickParticipant" | "handleHold"> & {
