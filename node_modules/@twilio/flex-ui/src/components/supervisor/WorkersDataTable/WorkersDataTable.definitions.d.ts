 ...
 */
export type WorkersDataTableProgrammableProps = Partial<Pick<WorkersDataTableProps, "filters" | "taskFilter" | "sortWorkers" | "sortCalls" | "sortTasks" | "defaultSortColumn" | "sortActivityTime" | "sortStatus">>;
...
export declare const defaultSortStatus: (a: SupervisorWorkerState, b: SupervisorWorkerState) => 1 | -1;
...
export type WorkersDataTableImplProps = ThemeProps & {
    ...
    sortStatus?: WorkersDataTableCompareFunction;
    showTeam?: boolean;
