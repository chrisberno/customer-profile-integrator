...
export declare const Connected: {
    ...
    displayName: string;
} & import("hoist-non-react-statics").NonReactStatics<React.FC<Pick<Pick<TaskCardChildrenProps & import("../../..").ThemeProps, "theme" | "conference" | "call" | "task" | "onClick" | "icon" | "firstLine" | "secondLine" | "channelDefinition" | "conversation" | "chatChannel"> & Partial<Pick<TaskCardChildrenProps & import("../../..").ThemeProps, "selected" | "highlighted">> & Partial<Pick<{
    highlighted: boolean;
    selected: boolean;
}, never>>, "conference" | "call" | "task" | "onClick" | "icon" | "selected" | "firstLine" | "secondLine" | "channelDefinition" | "conversation" | "chatChannel" | "highlighted"> & {
