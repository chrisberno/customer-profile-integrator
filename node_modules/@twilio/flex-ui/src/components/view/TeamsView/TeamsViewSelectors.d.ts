...
import { QueuesPreferenceData } from "../../../state/QueuesState/QueuesStateTypes";
...
export declare const fetchQueuesPreference: () => Promise<QueuesPreferenceData>;
export declare const queuesFilterSelector: import("reselect").OutputSelector<FlexState, FilterDefinition, (res: QueuesPreferenceData) => FilterDefinition>;
