...
export declare class TeamsView extends React.PureComponent<TeamsViewProps> {
     ...
     * Queues filter
     * @static
     * @type {queuesFilterSelector}
     * @readonly
     * @since 2.12.0
     */
    static queuesFilter: import("reselect").OutputSelector<FlexState, FilterDefinition, (res: import("../../../state/QueuesState/QueuesStateTypes").QueuesPreferenceData) => FilterDefinition>;
    /**
     * Default properties
     * @static
...
export declare const Connected: import("react-redux").ConnectedComponent<React.FC<Pick<TeamsViewImplStateProps & import("../../theme").ThemeProps & {
...
}, "selectedTaskSid" | "filters" | "isViewActive" | "teams" | "agentMetricsColumnsPreference" | "isNewTeamsViewEnabled" | "isQueuesColumnEnabled" | "preferenceHooks" | "teamsHierarchy" | "selectedTeams" | "isGraphQLPreferenceEnabled" | "hiddenFilter" | "selectedWorkerSid" | "textSearch" | "isNewTeamsViewColumnsEnabled" | keyof TeamsViewImplStateProps> & {
    ...
    theme?: import("@emotion/react").Theme;
}, "workers" | "appliedFilters" | "legacyFilters" | "appliedLegacyFilterQuery" | "flexUserSid" | "selectedTask" | "selectedWorker" | "monitoredTaskSid" | "stickyWorker" | "isLoadingWorkers" | "errorLoadingWorkers" | "isSearchFilterApplied" | "appliedFiltersCount" | "filterDefinitions" | "filterQuery"> & import("../../theme").ThemeProps & {
    isViewActive?: boolean;
    hiddenFilter?: import("../../../state/Supervisor/SupervisorState.definitions").AppliedFilter | import("../../../state/Supervisor/SupervisorState.definitions").AppliedFilter[] | string;
    filters: (FilterDefinition | FilterDefinitionFactory)[];
    selectedTaskSid?: string;
