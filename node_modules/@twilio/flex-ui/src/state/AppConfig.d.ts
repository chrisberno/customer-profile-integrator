 ...
 * @memberof Config
 */
export interface SSOConfig extends FlexSSOUrls {
    accountSid?: string;
    idpUrl?: string;
    loginPopup?: boolean;
...
export interface FlexSSOUrls {
    flexSSOServiceRedirectUrl?: string;
    flexSSOAuthorizeUrl?: string;
    flexSSOTokenUrl?: string;
}
/**
