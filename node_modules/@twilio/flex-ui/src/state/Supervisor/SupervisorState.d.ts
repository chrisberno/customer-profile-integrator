...
import { QueuesPreferenceData } from "../QueuesState/QueuesStateTypes";
/**
...
export interface SupervisorState {
    ...
    readonly queuesPreference: QueuesPreferenceData;
}
...
export type SupervisorStateAction = {
    ...
    type: typeof UPDATE_QUEUES_PREFERENCE;
    payload: QueuesPreferenceData;
};
...
export declare const UPDATE_QUEUES_PREFERENCE = "UPDATE_QUEUES_PREFERENCE";
...
export declare class Actions {
    ...
    static updateQueuesPreference(queuesPreference: QueuesPreferenceData): void;
