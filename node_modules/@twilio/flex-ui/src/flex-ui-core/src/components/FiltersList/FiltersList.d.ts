 ...
 *
 * @enum {"multiValue" | "multiSelect"} FiltersListItemType
 * @memberof FiltersList
 * @property {"multiValue"} multiValue - Renders a type of filter input supporting multiple options
 * @property {"multiSelect"} multiSelect - Renders a type of multi select filter input combox
 * @private
 */
...
export interface FiltersListProps {
    ...
    applyFilters: (data?: FiltersData, legacyFilterQuery?: string) => void;
...
interface FiltersListState {
    ...
    lastAppliedFilters?: FiltersListProps["appliedFilters"];
}
/**
 * @class FiltersList
 * @classdesc A component rendering a list of dynamic filters.
 * Can be themed with `Theme.FiltersList` in [Theme](Theme).
 *
 * @component
 ...
 * @private
 */
export declare class FiltersList extends React.Component<FiltersListProps, FiltersListState> {
    ...
    static getDerivedStateFromProps(props: FiltersListProps, state: FiltersListState): {
        selectedLegacyFilterQuery: string;
        currentFilters: FiltersData;
        lastAppliedFilters: FiltersData;
        expandedFilterId: string;
    };
    static getDefaultFilterValues(filters: Array<FilterDefinition>): FiltersData;
    translateFilterOptions: (options: Array<FilterDefinitionOption>, filterId: string) => FilterDefinitionOption[];
    render(): JSX.Element;
