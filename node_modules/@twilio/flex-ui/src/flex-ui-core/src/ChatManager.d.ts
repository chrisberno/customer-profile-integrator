...
interface ChatManagerConfig {
    ...
    disableTextAndAttachmentSendingRestriction: boolean;
}
...
export declare class ChatManager {
    ...
    static initialize(initial: {
        ...
        getInteractionChannelTypeByConversationSidCallback: GetInteractionChannelTypeByConversationSidFunction;
    ...
    static getInteractionChannelTypeByConversationSid(conversationSid: string): string;
    static disableTextAndAttachmentSendingRestriction(): boolean;
    static destroy(): void;
}
export {};
