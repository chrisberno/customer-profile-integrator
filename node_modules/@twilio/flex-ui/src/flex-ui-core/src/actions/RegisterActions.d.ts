 ...
 * @memberof Actions
 */
export interface ChatActionContentTemplateVariable {
    name: string;
    value: string;
}
/**
 ...
 * @memberof Actions
 */
export interface ChatActionSendRichContentMessagePayload extends ChatActionPayload {
    contentSid: string;
    contentVariables?: ChatActionContentTemplateVariable[];
    messageAttributes?: any;
}
/**
...
export declare class ChatActions {
    ...
    private static sendRichContentMessage;
